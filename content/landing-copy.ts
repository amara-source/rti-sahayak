export const landingCopy = {
  ...
  categories: {
    ...
    items: [
      ...
      { id: "e-district-services", label: "e-District Services", description: "District certificates and citizen service listings.", icon: "district" },
      ...
      { id: "public-grievance", label: "Public Grievance", description: "Public grievance and complaint service listings.", icon: "grievance" },
      ...
      { id: "utility-bill-payments", label: "Utility & Bill Payments", description: "Utility accounts and bill payment service listings.", icon: "utility" },
      { id: "general", label: "General", description: "General citizen services across public bodies.", icon: "general" },
    ],
  },
  haq: {
